...
<div className="flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-8 my-8 p-4 ">
          ...
          <div className="relative w-full max-w-lg h-auto overflow-hidden rounded-lg shadow-xl group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center p-4 text-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              ...
              <p className="text-white txt mb-4 max-w-md">
                ...
                secure and scalable Car App with dual interfaces for Admin and
                Normal Users, leveraging modern web technologies for performance
                and security.
              </p>
          ...
          <div className="relative w-full max-w-lg h-auto overflow-hidden rounded-lg shadow-xl group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center p-4 text-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              ...
              <p className="text-white txt mb-4 max-w-md">
                MediMeet — A doctor-patient video consultation platform built
                with Next.js, Tailwind, ShadCN, Prisma, Neon, and Vonage.
                Features role-based access for Admin, Doctor, and Patient.
              </p>
              <Link href={"https://github.com/KartikSaxena19/MediMeet"}>
                <button className="px-6 py-2 bg-white text-black rounded-lg txt hover:bg-gray-200 transition">
                  View Code
                </button>
              </Link>
          ...
          <div className="relative w-full max-w-lg h-auto overflow-hidden rounded-lg shadow-xl group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center p-4 text-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              ...
              <p className="text-white txt mb-4 max-w-md">
                Secure donation system made with nextjs, tailwind css and
                mongodb, payment integration with razorpay
              </p>
          ...
          <div className="relative w-full max-w-lg h-auto overflow-hidden rounded-lg shadow-xl group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center p-4 text-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              ...
              <p className="text-white txt mb-4 max-w-md">
                Password manager made with vite+react, tailwind css and mongodb,
                used to save the password of any website
              </p>
